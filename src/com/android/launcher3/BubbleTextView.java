...
public class BubbleTextView extends TextView {
    ...
    public void updateIconUnistallMode(IconCache iconCache, boolean unistall){
    	if(mInfo == null){
    		Log.e("Unistall", "DucTMc: updateIconUnistallMode mInfo null. I cant draw icon");
    	}
    	Bitmap b = mInfo.getIcon(iconCache);
    	LauncherAppState app = LauncherAppState.getInstance();
        DeviceProfile grid = app.getDynamicGrid().getDeviceProfile();
        setCompoundDrawables(null,
                Utilities.createUnistallIconDrawable(b, unistall, getResources()), null, null);
        setCompoundDrawablePadding(grid.iconDrawablePaddingPx);
        setText(mInfo.title);
        // DucTMc: pls make sure It is safe. So dangerous
    }
}
