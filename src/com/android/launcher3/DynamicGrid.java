...
public class DynamicGrid {
    ...
    // DucTMc: so item trong 1 dong
    public static final int NUM_ITEM_PER_ROW = 4;
    ...
    public DynamicGrid(Context context, Resources resources,
        ...
        deviceProfiles.add(new DeviceProfile("Nexus S", 
                296, 491.33f,  5 /*DucTMc: sua 4*/, 4,  48, 13, (hasAA ? NUM_ITEM_PER_ROW : NUM_ITEM_PER_ROW /*DucTMc: truoc kia la 5:5*/), 48, R.xml.default_workspace_4x4));
        deviceProfiles.add(new DeviceProfile("Nexus 4",
                335, 567,  5 /*DucTMc: sua 4*/, 4,  DEFAULT_ICON_SIZE_DP, 13, (hasAA ? NUM_ITEM_PER_ROW : NUM_ITEM_PER_ROW /*DucTMc: truoc kia la 5:5*/), 56, R.xml.default_workspace_4x4));
        deviceProfiles.add(new DeviceProfile("Nexus 5",
                359, 567, 5 /*DucTMc: sua 4*/, 4,  DEFAULT_ICON_SIZE_DP, 13, (hasAA ? NUM_ITEM_PER_ROW : NUM_ITEM_PER_ROW /*DucTMc: truoc kia la 5:5*/), 56, R.xml.default_workspace_4x4));
