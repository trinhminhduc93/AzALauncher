...
public class LauncherAppState implements DeviceProfile.DeviceProfileCallbacks {
    ...
    // DucTMc: cho load toan bo app ra. Xem lai dieu kien
    //TODO: 
    public static boolean isDisableAllApps() {
        // Returns false on non-dogfood builds.
    	Log.v(Launcher.DISABLE_ALL_APPS_PROPERTY, "isDisableAllApps");
    	boolean isDogFood = getInstance().mBuildInfo.isDogfoodBuild();
    	boolean isPropertyEnabled = Utilities.isPropertyEnabled(Launcher.DISABLE_ALL_APPS_PROPERTY);
    	System.out.println("DucTMc: isDogFood= "+ isDogFood+ " isPropertyEnabled= "+ isPropertyEnabled);
        return /* isDogFood && isPropertyEnabled*/ true;
    }
